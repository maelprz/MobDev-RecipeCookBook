...
class SnacksRecipesScreen extends StatefulWidget {
  const SnacksRecipesScreen({super.key});

  @override
  State<SnacksRecipesScreen> createState() => _SnacksRecipesScreenState();
}

class _SnacksRecipesScreenState extends State<SnacksRecipesScreen> {
  ...
  final List<Map<String, dynamic>> recipes = const [
    {
      'imagePath': 'assets/home_screen/category-snacks.jpg',
      'title': 'French Fries',
      'time': '15 min',
      'difficulty': 'Easy',
      'isFavorite': false,
