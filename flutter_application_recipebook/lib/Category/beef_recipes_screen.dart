...
class BeefRecipesScreen extends StatefulWidget {
  const BeefRecipesScreen({super.key});

  @override
  State<BeefRecipesScreen> createState() => _BeefRecipesScreenState();
}

class _BeefRecipesScreenState extends State<BeefRecipesScreen> {
