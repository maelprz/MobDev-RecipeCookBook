...
class SeafoodRecipesScreen extends StatefulWidget {
  const SeafoodRecipesScreen({super.key});

  @override
  State<SeafoodRecipesScreen> createState() => _SeafoodRecipesScreenState();
}

class _SeafoodRecipesScreenState extends State<SeafoodRecipesScreen> {
